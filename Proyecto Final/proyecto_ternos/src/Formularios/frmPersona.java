...
public class frmPersona extends javax.swing.JFrame {
    ...
    public void nombresTitulos() {
        String[] tit = {"DNI", "Nombre", "Apellido Paterno", "Apellido Materno", "Dirección", "Telefono", "Correo Electronico","Id Tipo Persona"};
    ...
    public void cargarDatos() {
        try {
            ...
            int[] anchosEs = {100, 200, 200, 250, 250, 200, 200, 200};
    ...
    public void guardarDatos() {
        ...
        try {
            Connection con = cn.conectar();
            ps = con.prepareStatement("insert into persona(DNI,nombre,apellido_p,apellido_m,direccion,telefono,email,fk_idtipo_persona)values (?,?,?,?,?,?,?,?);");
            ...
            ps.setString(8, jTextField_fk_id_tipo_persona.getText());
    ...
    private void initComponents() {
        ...
        jPanel1.add(jToolBar2, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 30, 790, -1));
